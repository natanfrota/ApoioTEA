...
<body>
    ...
    <div class="main-content">
        ...
        <div class="atividade-cartao">
            ...
            <h4>Publicado por: <a href="perfil_familia.html" class="link-familia">Família Silva</a></h4>
        ...
        <div class="atividade-cartao">
            ...
            <h4>Publicado por: <a href="perfil_familia.html" class="link-familia">Família Oliveira</a></h4>
        ...
        <div class="atividade-cartao">
            ...
            <h4>Publicado por: <a href="perfil_familia.html" class="link-familia">Família Souza</a></h4>
        ...
        <div class="atividade-cartao">
            <h3>Outras atividades</h3>
            <h4>Publicado por: <a href="perfil_familia.html" class="link-familia">Família Costa</a></h4>
